...
"[project]/src/app/api/family/[familyId]/members/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request, context) {
    ...
    const { data: isMember, error: memberError } = await supabase.from('list_members').select('role').eq('list_id', familyId).eq('profile_id', user.id).single();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__18d0da32._.js.map