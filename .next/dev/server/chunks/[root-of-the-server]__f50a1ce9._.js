...
"[project]/src/app/api/lists/[familyId]/members/[memberId]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function DELETE(request, context) {
    ...
    if (listError || !list) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: `List not found for familyId: ${familyId}`
        }, {
            status: 404
        });
    }
    if (list.user_id !== user.id) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'Only the list owner can remove members'
        }, {
            status: 403
        });
    }
    // Delete the member from the list_members table
    const { error: removeMemberError } = await supabase.from('list_members').delete().eq('list_id', familyId).eq('profile_id', memberId);
    ...
    const { error: deleteItemsError } = await supabase.from('items').delete().eq('list_id', familyId).eq('user_id', memberId);
    if (deleteItemsError) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f50a1ce9._.js.map